...
class Reservation(models.Model):
    ...
    date = models.DateTimeField(blank=True)
    take_off = models.CharField(max_length=20, choices=CHOICE, default='-')
    arrive = models.CharField(max_length=20, choices=CHOICE, default='-')
...
class ReservationForm(ModelForm):
    class Meta:
        model = Reservation
        fields =['first_name', 'last_name', 'phone', 'date', 'take_off', 'arrive','country']
